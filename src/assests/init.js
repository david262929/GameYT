import {toShakeIt, getSuchka} from '@assests/functions';
import {width, height, boomMinimumLimit} from '@assests/configs';
import {createField} from '@assests/createField';
...
field_element.addEventListener("click", function (event) {
    ...
    selectCell(cells[generateKey(+cellElement.dataset.x, +cellElement.dataset.y)])
});
